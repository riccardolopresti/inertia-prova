...
header{
    background-color: rgba(51, 51, 51, 0.478);
    height: 80px;
    position: fixed;
    top: 0;
    left: 0;
  ...
  .navbar__menu {
    ...
    .navbar__item {
      ...
      #contact-me{
        ...
        &.active{
            color: #ffffff;
            background: rgba(18, 18, 18, 0.939);
            border: 1.7px solid #ffff;
            font-weight: 400;
        }
      }
    }
